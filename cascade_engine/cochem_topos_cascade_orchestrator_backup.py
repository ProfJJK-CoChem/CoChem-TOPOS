...
class CascadeOrchestrator:
    ...
    def _compute_true_hessian(self, atoms, calc, prefix: str) -> list:
        ...
        try:
            ...
            if hasattr(vibrations, 'get_force_constant_matrix'):
                hessian = vibrations.get_force_constant_matrix()
            elif hasattr(vibrations, 'get_hessian_2d'):
    ...
    def process_geometry(self, geom_id: str, initial_xyz: str, complex_flag: bool = False) -> OrchestratorPayload:
        ...
        """
        complex_flag = complex_flag or self.config.complex_flag
